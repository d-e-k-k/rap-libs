		...
		<div className='results'>
			{parent.length >= InputListData.length ? (
				<div className='results-inner'>
					...
					<p>
						In the{' '}
						<span style={{ fontWeight: 'bold' }}>{parent[0].userInput}</span>
					</p>
					<p>It made my week long,</p>
					<p>
						And my brain{' '}
						<span style={{ fontWeight: 'bold' }}>
							{parent[0].rhymingWord[Math.floor(Math.random() * 5)]}
						</span>
					</p>
					<br />
					...
					<p>
						Like I change my{' '}
						<span style={{ fontWeight: 'bold' }}>{parent[1].userInput}</span>.
					</p>
					<p>Change my name,</p>
					<p>
						Call me "
						<span style={{ fontWeight: 'bold' }}>
							{parent[1].rhymingWord[Math.floor(Math.random() * 5)]}
						</span>
						"
					</p>
					<br />
					...
					<p>
						Rap game{' '}
						<span style={{ fontWeight: 'bold' }}>{parent[2].userInput}</span>
					</p>
					<p>
						Code game{' '}
						<span style={{ fontWeight: 'bold' }}>
							{parent[2].rhymingWord[Math.floor(Math.random() * 5)]}
						</span>
					</p>
					<p>
						useState{' '}
						<span style={{ fontWeight: 'bold' }}>{parent[3].userInput}</span>
					</p>
					<p>
						useEffect{' '}
						<span style={{ fontWeight: 'bold' }}>
							{parent[3].rhymingWord[Math.floor(Math.random() * 5)]}
						</span>
					</p>
					<br />
					<p>No new props,</p>
