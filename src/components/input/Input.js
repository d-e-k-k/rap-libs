...
// const Input = ({ setRhymingWords, words, setWords }) => {

// 	// function handleChange(event){
		
// 	// 	setWords({ ...words, [event.target.id]: event.target.value, "lenght": "other" });
// 	// }
...
// 						<input id={item.id} type='text' onBlur={handleBlur} onChange={handleChange} required />
// 					</li>
// 				);
// 				}
// 				)}
